...
export const ACHIEVEMENT_TYPE_CONFIG: Record<AchievementType, {
  ...
  micro: {
    label: 'Micro Win',
    labelRu: 'Микро-победа',
    icon: 'zap',
    color: '#22c55e',
    description: 'Маленькие, но важные шаги вперед'
  },
  macro: {
    label: 'Major Goal',
  ...
  moment: {
    label: 'Magic Moment',
    labelRu: 'Магический момент',
    icon: 'sparkles',
    color: '#f59e0b',
    description: 'Спонтанные радостные моменты'
  }
}
...
export const ACHIEVEMENT_CATEGORY_CONFIG: Record<AchievementCategory, {
  ...
  finance: { label: 'Finance', labelRu: 'Финансы', icon: 'wallet', color: '#14b8a6' },
  relationships: { label: 'Relationships', labelRu: 'Отношения', icon: 'users', color: '#f97316' },
  other: { label: 'Other', labelRu: 'Другое', icon: 'circle', color: '#6b7280' }
}
