...
import { Github, Loader2, CheckCircle2, Eye, EyeOff, Check } from "lucide-react"

const MIN_SUBMIT_INTERVAL = 3000

const baseInput = "h-11 bg-white/8 border-white/15 text-white placeholder:text-white/40 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-[#141414] transition-colors"
const inputNormal  = `${baseInput} focus:border-white/60 focus-visible:ring-white/60`
const inputError   = `${baseInput} border-red-500/70 focus:border-red-500/80 focus-visible:ring-red-500/40`
const inputSuccess = `${baseInput} border-green-500/60 focus:border-green-500/70 focus-visible:ring-green-500/40`
    ...
    <div className="space-y-6">
      ...
      <div className="relative">
        ...
        <div className="relative flex justify-center text-xs">
          <span className="bg-[#141414] px-2 text-white/40">или зарегистрируйтесь через</span>
        </div>
      </div>
