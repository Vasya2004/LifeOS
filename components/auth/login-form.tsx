...
import { Loader2, Eye, EyeOff, UserRound, AlertTriangle } from "lucide-react"
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <span className="text-xs text-white/40 shrink-0">или войдите через</span>
        <div className="flex-1 h-px bg-white/10" />
      </div>
      ...
      <Button
        variant="outline"
        className="h-12 w-full rounded-2xl border-white/15 text-white/60 hover:bg-white/[0.07] hover:text-white bg-transparent transition-colors"
        onClick={handleGuest}
        disabled={isPending}
      >
